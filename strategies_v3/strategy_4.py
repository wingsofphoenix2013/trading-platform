...
# 🔸 Стратегия strategy_4 с проверкой EMA50 и ATR
class Strategy4:
    def __init__(self):
        pass
    ...
    async def on_signal(self, task: dict, interface):
        debug_log("📈 Продолжение логики внутри strategy_4...")
...
#                 return
        ...
        debug_log(f"📊 Расчёт позиции (strategy_4): "
        ...
        if position_id:
            logging.info(f"✅ Позиция открыта strategy_4, ID={position_id}")
        else:
