### Стратегия vilarso_m5_fulltp — реверсивная логика входа и выхода

"""
Стратегия vilarso_m5_fulltp: реверсивная логика входов по управляющему сигналу.
...
async def process_signal(log_id: int):
    print(f"[STRATEGY] vilarso_m5_fulltp: запуск обработки log_id={log_id}", flush=True)
