### Стратегия lx_m5_strict — реверсивная логика входа и выхода

"""
Стратегия lx_m5_strict: реверсивная логика входов по управляющему сигналу.
...
async def process_signal(log_id: int):
    print(f"[STRATEGY] lx_m5_strict: запуск обработки log_id={log_id}", flush=True)
